...
public class ArbolithBlockStateProvider extends BlockStateProvider {
    public ArbolithBlockStateProvider(PackOutput output, ExistingFileHelper exFileHelper) {
        super(output, Arbolith.MOD_ID, exFileHelper);
    }
    ...
    private void addWoodSetBlocks(WoodSet woodSet) {
        ...
        hangingSignBlock(woodSet.getHangingSignBlock().get(), woodSet.getWallHangingSignBlock().get(), blockTexture(woodSet.getPlanksBlock().get()));
    }
