...
public class TreeTypes {
    ...
    public static final TreeType BLOOMING_OAK_TREE_TYPE = new TreeType("blooming_oak", "Blooming Oak")
            .withConfiguration("normal", ((leavesBlock, hasBees) -> new TreeConfiguration.TreeConfigurationBuilder(
    ...
    public static void addToDeferredRegister(DeferredRegister<Block> blockDeferredRegister) {
        TREE_TYPES.forEach((woodSet -> {
            woodSet.addToDeferredRegister(blockDeferredRegister);
        }));
    }
}
